            ...
            <section id="link01">
                                ...
                                <li class="rlistbox__item">
                                    ...
                                    <div class="rlistbox__item--wh">
                                        <!-- <p>
                                            ...
                                            <a
                                                href="https://wst1.asts.jp/golfnet/cc/0213cc/compe/index_kumi.asp" target="_blank" rel="noopener noreferrer">WEB入力用の組み合わせ送信フォーム</a>をご利用ください。キャディバッグ配送の有無、カートの積み込み順もご指定いただけます。<br>
                                            また、<a href="#res_form">組み合わせ送信フォーム（エクセル・PDF）</a>もご利用ください。
                                        </p> -->
                                        <!--組み合わせフォーム公開時は以下を上記を戻し、以下を削除-->
                                        <p>
                                            メンバーの組み合わせのご連絡については<br>
                                            <a href="#res_form">組み合わせ送信フォーム（エクセル・PDF）</a>をご利用ください。キャディバッグ配送の有無、カートの積み込み順もご指定いただけます。<br>
                                        </p>
                                    </div>
                                </li>
                                <li class="rlistbox__item">
                ...
                <div class="c-column border _nv">
                    <div class="rcol">
                        ...
                        <p class="dot">弊クラブ利用約款第3条のとおり、ご予約可能組数は、土曜日は会員1名につき1組、日祝日は2組、平日は原則として5組までとさせて頂きます。</p>
                        ...
                        <div class="res__rental" id="rental">
                            ...
                            <ul class="c-list">
                                ...
                                <li><span>※</span>レンタル用品についてはわずかしかご用意がございません。<br>必要に応じてレンタルクラブ会社からお借りすることも可能ですので、プレーの一週間前までにご予約ください。<br>ブランド等の指定も可能です。（レンタル料金：8,800円）</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tabContent active">
                        <ul class="pflow">
                            <li class="pflow__arrow_box _01">
                                ...
                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/reservation/img_01.jpg" alt="ご来場" class="img">
                            ...
                            <li class="pflow__arrow_box _03">
                                ...
                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/reservation/img_03.jpg" alt="お着替え" class="img">
                            ...
                            <li class="pflow__arrow_box _05">
                                ...
                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/reservation/img_05.jpg" alt="練習" class="img">
                            ...
                            <li class="pflow__arrow_box _06">
                                ...
                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/reservation/img_06.jpg" alt="キャディご挨拶" class="img">
                            ...
                            <li class="pflow__arrow_box _07">
                                ...
                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/reservation/img_07.jpg" alt="ラウンドスタート（前半）" class="img">
                            ...
                            <li class="pflow__arrow_box _08">
                                ...
                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/reservation/img_08.jpg" alt="前半終了" class="img">
