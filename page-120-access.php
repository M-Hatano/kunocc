  ...
  <div class="c-column">
    ...
    <table class="tb-01">
      <tbody>
        <tr>
          <th>所在地</th>
          <td>〒286-0203 千葉県富里市久能７２２</td>
        </tr>
        <tr>
          <th>電話</th>
          <td>0476-93-9000(代)</td>
        </tr>
        <tr>
          <th>FAX</th>
          <td>0476-92-5063</td>
    ...
    <section id="link01">
      ...
      <div class="abox">
        ...
        <img
          src="<?php echo esc_url(get_template_directory_uri()); ?>/img/access/img_access_01.jpg"
          alt="車使用時"
          class="for-pc abox__mod">

        <img
          src="<?php echo esc_url(get_template_directory_uri()); ?>/img/access/img_access_02.jpg"
          alt="アクセスマップ"
          class="for-pc">

        <img
          src="<?php echo esc_url(get_template_directory_uri()); ?>/img/access/img_access_04.jpg"
          alt="車使用時"
          class="for-sp">

        <a
          href="<?php echo esc_url(get_template_directory_uri()); ?>/img/access/kunomap.pdf"
          class="c-btn"
          target="_blank"
          rel="noopener noreferrer">印刷用PDFダウンロード</a>
      </div>
    </section>
    ...
    <section id="link02">
      ...
      <div class="abox for-sp">
        <img
          src="<?php echo esc_url(get_template_directory_uri()); ?>/img/access/img_access_05.jpg"
          alt="電車をご利用の方"
          class="for-sp">
      </div>
      ...
      <div class="abox for-sp">
        <img
          src="<?php echo esc_url(get_template_directory_uri()); ?>/img/access/img_access_06.jpg"
          alt="電車をご利用の方"
          class="for-sp">
      </div>
    </section>
    ...
    <section id="link03">
      ...
      <a
        href="<?php echo esc_url(get_template_directory_uri()); ?>/img/access/bus161102-1.pdf"
        class="c-btn _cbus"
        target="_blank"
        rel="noopener noreferrer">クラブバス乗り場案内図はこちら（PDF）</a>
    </section>
