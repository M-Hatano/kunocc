...
// ★ フォールバック：member_category が取れない場合は URL から推定
if (!$subcat) {
...
// taxonomy クエリ（member_post 側のタクソノミー名に合わせる）
$tax_query_member = [[
  ...
  <div class="c-column">
    <div class="news-box">
      ...
      <div class="news-box__left">
        ...
        <h2 class="c-head6"><?php echo esc_html($label); ?><span><?php echo esc_html($year); ?>年</span></h2>
          ...
          <div class="recent-posts-box">
            ...
            <ul>
              ...
              $recent_q = new WP_Query([
                  ...
                  'posts_per_page'      => 5,
                  'ignore_sticky_posts' => true,
                  'tax_query'           => $tax_query_member, // ★ 同じカテゴリに統一
              ]);
