      ...
      */
      ...
      $allowed_domains = [
        ...
        //入力者宛てメール 本文
          ...
          $text1.= "====================================================\n";
          $text1.= "富士平原ゴルフクラブ \n\n";
          $text1.= "〒412-0001 静岡県御殿場市水土野300－1\n";
          $text1.= "　TEL：0550-89-2000 \n";
          $text1.= "　FAX：0550-89-6703 \n";
          $text1.= "====================================================\n";
          
        //管理者宛てメール 本文	
          $text2 = '';
          $text2 .= "富士平原ゴルフクラブ　お問い合わせご担当者様\n\n";
          ...
          //管理者宛てメール 本文以外	
          $title2 = '【富士平原ゴルフクラブ】HPからお問い合わせがありました';
